...
Before changing release artifacts, manifests, release notes, firmware publication flow, checksums, download structure, or security/privacy behavior, read the source-of-truth documents in the Home Assistant integration repo:
...
`pcvantol/djconnect-firmware` is a public release/distribution surface for firmware artifacts and release metadata.
...
- Keep firmware artifacts, manifests, checksums, and release notes aligned.
