...
Repository: `pcvantol/djconnect-firmware`
...
public firmware release distribution artifacts only.

## Ownership Boundary

This repository owns public firmware release binaries, firmware_manifest.json, release metadata and non-secret release/install documentation.

This repository does not own ESP32 source code, firmware architecture, Home Assistant integration behavior or foundation docs.
